...
ggplot(affinities, aes(semantic_affinity, abs(correlations))) + geom_point() + 
  geom_smooth(method = "lm", se = F) + geom_text(aes(x = semantic_affinity + 0.005, label = NEO)) + 
  xlab("Semantic affinity") + ylab("Abs. correlation NEO with PID sum") + 
  theme_classic()
```
