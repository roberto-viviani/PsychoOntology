...
ggplot(
  ...
  xlab("NEO trait") + ylab("avg correlation") + theme_grey() + 
...
One aspect of conscientiouness is the relative low correlations of participant responses with the anancasticity PID domain, even if the model cosidered the items fairly semantically related. Examining this trait specifically, we find
