...
# create a group ordering for PID facets that respsects traits
library(forcats)
...
ggplot(filter(cordata, typeNEO == "Neuroticism"), 
       aes(cosdist, corrs)) + 
  geom_point(aes(fill = typePID, color = typePID), alpha=0.5, shape=21, size=2.4) + 
  geom_smooth(aes(group = corrs > 0), color = "grey", method = "lm", se = F) + 
  geom_text(data = filter(cordata, typeNEO == "Neuroticism", cosdist < 0.43 | corrs > 0.5), 
            aes(label = typePID), alpha = 0.3) +
  labs(title = "Neuroticism") +
  xlab('semantic distance') + ylab('responses correlation') + theme_classic()
#ggsave("neuroticism_openAI_large.pdf", width = 150, height = 95, units = "mm")
...
ggplot(filter(cordata, typeNEO == "Extraversion"), 
  ...
  xlab('semantic distance') + ylab('responses correlation') + theme_classic()
#ggsave("extraversion_openAI_large.pdf", width = 150, height = 95, units = "mm")
...
ggplot(filter(cordata, typeNEO == "Conscientiousness"), 
  ...
  xlab('semantic distance') + ylab('responses correlation') + theme_classic()
#ggsave("conscientiousness_openAI_large.pdf", width = 150, height = 95, units = "mm")
...
ggplot(filter(cordata, typeNEO == "Agreeableness"), 
  ...
  xlab('semantic distance') + ylab('responses correlation') + theme_classic()
#ggsave("agreeableness_openAI_large.pdf", width = 150, height = 95, units = "mm")
...
ggplot(filter(cordata, typeNEO == "Openness"), 
  ...
  labs(title = "Openness") +
  xlab('semantic distance') + ylab('responses correlation') + theme_classic()
#ggsave("openness_openAI_large.pdf", width = 150, height = 95, units = "mm")
