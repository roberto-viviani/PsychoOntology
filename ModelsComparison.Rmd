...
Universal Sentence Encoder embeddings are not based on a language model and are publicly available on the TensorFlow site.
...
distmx_pooled <- (distmx_openAI + distmx_gecko + distmx_USE) / 3
