...
distmx_pooled <- (distmx_openAI + distmx_gecko + distmx_roberta + distmx_USE) / 4
...
This reveals that the average model performs just better than the best model. However, the advantage accruing from pooling the models is small.

We add Mistral to the pool, to verify robustness to model selection.
